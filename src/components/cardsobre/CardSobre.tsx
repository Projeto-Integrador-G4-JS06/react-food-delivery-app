...
function CardSobre({
  ...
  return (
    <div
      className="flex flex-col bg-[#f6eed9] border-1 border-[#FFA500] max-w-sm rounded-xl
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 mt-30 mb-4 px-4">
        ...
        <div className="flex mt-6 gap-0  max-sm:gap-8 lg:gap-8">
          <a
            href={linkedin}
            target="_blank"
            className="text-[#CD533B] rounded-md max-sm:border-0
                     hover:bg-[#ffa600] hover:text-white 
                    flex items-center justify-center w-10 h-10 md:w-25 md:h-auto lg:h-auto md:py-2 "
          >
          ...
          <a
            ...
            className="text-[#CD533B] rounded-md max-sm:border-0
                     hover:bg-[#ffa600] hover:text-white 
                    flex items-center justify-center w-10 h-10 md:w-25 md:h-auto md:py-2"
          >
