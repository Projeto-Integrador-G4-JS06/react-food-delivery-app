...
interface CardProdutosSaudaveisProps {
  produto: Produto;
}

function CardProdutosSaudaveis({ produto }: CardProdutosSaudaveisProps) {
  const [isHovered, setIsHovered] = useState(false);

  return (
    <div
      className="w-90  h-auto sm:w-139 mx-auto m-6 bg-amber-50 border border-amber-200 rounded-xl p-4 shadow-lg flex drop-shadow-xl transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg"
...
export default CardProdutosSaudaveis;
